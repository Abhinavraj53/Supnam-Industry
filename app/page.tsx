    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-orange-50 border-b border-orange-100">
        <div className="pattern-bg">
          <div className="max-w-7xl mx-auto px-4 py-10 lg:py-14 grid lg:grid-cols-[1.1fr_1fr] gap-10 items-center">
            <div className="fade-in">
              <div className="inline-flex items-center gap-2 bg-white border border-orange-200 text-brand px-3 py-1 rounded-sm text-xs font-bold uppercase tracking-wider mb-5 shadow-sm">
                <BadgeCheck className="w-3.5 h-3.5" /> TrustSEAL Verified Supplier
              </div>
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
                {home.heroTitle || company.name}
              </h1>
              <p className="text-brand text-lg md:text-xl font-semibold mb-4 tracking-wide">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/categories" className="inline-flex items-center gap-2 bg-brand hover:bg-orange-600 text-white px-6 py-3 rounded-md font-semibold shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all">
                  View Our Products <ArrowRight className="w-4 h-4" />
                </Link>
                <Link href="/contact" className="inline-flex items-center gap-2 bg-white border-2 border-gray-800 hover:bg-gray-900 hover:text-white text-gray-900 px-6 py-3 rounded-md font-semibold transition-all">
            ...
            <div className="relative fade-in">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                <img src={heroImage} alt="Pujan Products" className="w-full h-[420px] object-cover" />
                <div className="absolute top-0 left-0 bg-brand text-white px-4 py-2 rounded-br-xl font-bold text-sm">
                  TRUSTED SINCE {company.establishedYear}
                </div>
              </div>
              <div className="absolute -bottom-5 left-5 bg-white rounded-xl shadow-xl p-3 flex items-center gap-3 border border-orange-100">
              ...
              <div className="absolute -bottom-5 right-5 bg-white rounded-xl shadow-xl p-3 flex items-center gap-3 border border-orange-100">
                <div className="w-11 h-11 rounded-lg bg-brand-light flex items-center justify-center">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-wrap items-center justify-center gap-4 md:gap-8 text-xs md:text-sm">
      ...
      <section className="py-10 lg:py-14 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-[1fr_1.2fr] gap-10 items-center">
          <div>
            ...
            <Link href="/about" className="inline-flex items-center gap-2 bg-brand hover:bg-orange-600 text-white px-6 py-3 rounded-md font-semibold transition-all">
      ...
      <section className="py-10 lg:py-14 bg-orange-50/50">
      ...
      <section className="py-10 lg:py-14 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-orange-600 via-brand to-orange-500 p-8 md:p-12 text-white shadow-xl">
            ...
            <div className="relative grid md:grid-cols-[1.5fr_1fr] gap-6 items-center">
              ...
              <div className="flex flex-col gap-3">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-white text-brand hover:bg-orange-50 px-6 py-3 rounded-md font-bold shadow-lg transition-all">
                  <MessageSquare className="w-4 h-4" /> Send Inquiry
                </Link>
                <a href={`tel:${company.phone.replace(/\s/g, '')}`} className="inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-md font-bold transition-all">
