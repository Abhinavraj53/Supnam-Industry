        ...
        <div className="max-w-7xl mx-auto px-4">
                ...
                <table className="w-full text-sm">
                  <tbody>
                    {productInfo.map((info, idx) => (
                      <tr key={info.label} className={idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                        <td className="py-3 px-4 font-semibold text-gray-700 w-1/3 border-r border-gray-100">{info.label}</td>
                        <td className="py-3 px-4 text-gray-900">{info.value}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div id="quote" className="mt-8 bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            <div className="grid lg:grid-cols-[1fr_1.2fr] gap-0">
              <div className="bg-gradient-to-br from-brand to-orange-600 text-white p-8 lg:p-10">
